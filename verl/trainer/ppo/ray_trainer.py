...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        if not self.config.do_search:
            ...
            for batch_dict in tqdm(self.val_dataloader, desc="Validation"):
                timing_raw = {}
    ...
    def fit(self):
        ...
        if self.val_reward_fn is not None and self.config.trainer.get(
            ...
            val_metrics_file = "val_metrics_initial.json"
            with open(val_metrics_file, "w") as f:
                json.dump(val_metrics, f, indent=2)
            pprint(f"Validation metrics saved to: {val_metrics_file}")
